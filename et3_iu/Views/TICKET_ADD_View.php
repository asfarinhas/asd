...
class TICKET_ADD_View
{
    ...
    public function showView()
    {
        ...
        <div>
            ...
            <form action="../Controllers/TICKET_Controller.php" name="formAddSubtarea" enctype="multipart/form-data" method="post" onsubmit="return validarFormAddSubtarea()">
