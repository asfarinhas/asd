    ...
    function render(){
        ...
        <?php include '../Locates/Strings_'.$_SESSION['IDIOMA'].'.php'; ?>
            <p>
              ...
              <?php echo $strings['Ver correo']; ?><br>
                ...
                <form action='CORREO_Controller.php' method='post'>
                    <ul class="form-style-1">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label for="id" class="control-label"><?php echo $strings['ID_CORREO']; ?>:</label>
                            </div>
                            <div class="col-sm-4">
                                <input type="text" readonly value="<?php echo $this->datos['ID_CORREO'];?>"class="form-control" name="ID_NOTIFICACION"  title="<?php echo $strings['error notificacion']; ?>" >
                            </div>
                        </div>
                        <!-- Campo Emisor -->
                        <div class="form-group">
