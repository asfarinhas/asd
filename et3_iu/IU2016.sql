...
) ENGINE=InnoDB AUTO_INCREMENT=405 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
--
ALTER TABLE `FUNCIONALIDAD`
  MODIFY `FUNCIONALIDAD_ID` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=401;
--
-- AUTO_INCREMENT de la tabla `PAGINA`
--
ALTER TABLE `PAGINA`
  MODIFY `PAGINA_ID` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=405;
--
