...
INSERT INTO `TAREA` (`PADRE`, `ID_TAREA`, `NOMBRE`, `FECHAIP`, `FECHAIR`, `FECHAEP`, `FECHAER`, `HORASP`, `HORASR`, `ID_MIEMBRO`, `ID_PROYECTO`, `DESCRIPCION`, `ESTADO`, `COMENTARIO`) VALUES
  (NULL, 1, 'TAREA1', '2017-01-02', '2017-01-03', '2017-01-18', '2017-01-18', 20, 15, 'ADMIN', 1, 'EJEMPLO', 0, 'EJEMPLO'),
  (1, 2, 'SUBTAREA1', '2017-01-10', '2017-01-10', '2017-01-16', '2017-01-15', 2, 2, 'ADMIN', 1, 'EJEMPLO', 0, 'EJEMPLO');
